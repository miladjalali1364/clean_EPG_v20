...
df1_1 = pd.read_excel(r'D:\python\EPG_vahid\input\source\sample\sepeher_1400_11.xlsx')
df1 = pd.read_excel(r'D:\python\EPG_vahid\input\source\sample\Aio-1400_11.xlsx')
df2 = pd.read_excel(r'D:\python\EPG_vahid\input\source\sample\telewebion_1400_11_v2.xlsx')
...
df4 = pd.read_excel(r'D:\python\EPG_vahid\input\source\sample\tva_1400_11.xlsx')

df5 = pd.read_excel(r'D:\python\EPG_vahid\input\source\sample\iranseda_1400_11.xlsx')


df2['tt']=df2['تاریخ تولید برنامه'].apply(lambda x: dt.datetime.strptime(x, '%Y-%m-%dT%H:%M:%SZ'))

df3.to_excel(r'D:\python\EPG_vahid\input\source\Estandard\test\lenz_13_out.xlsx', index=False)
